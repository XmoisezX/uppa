...
export function RecentProperties({ properties }: RecentPropertiesProps) {
  ...
  return (
    <section id="recentes" className="py-12 sm:py-16 bg-white dark:bg-slate-950 border-b border-slate-200/80 dark:border-slate-800">
        ...
        <div className="flex flex-col sm:flex-row sm:items-end justify-between mb-8 gap-4">
          <div>
            ...
            <p className="text-xs sm:text-sm text-slate-500 dark:text-slate-400 mt-1">
              Últimas oportunidades reais cadastradas por imobiliárias e corretores parceiros
            </p>
          </div>
          <Link
            href="/comprar"
