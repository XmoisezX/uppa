...
import { FloatingPropertyBubbles } from "./FloatingPropertyBubbles";
import type { ActiveCitySummary, HeroBubbleProperty } from "../services";
...
export function PropertySearchHero({
  ...
  // =========================================================================
  // FORMULÁRIO DO FILTRO EXATO DE BUSCA (Reutilizado fielmente em ambos os modos)
  // =========================================================================
