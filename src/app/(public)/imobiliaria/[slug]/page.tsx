    ...
    <div className="mx-auto max-w-5xl px-4 py-12 sm:px-6 lg:px-8">
      ...
      <div className="rounded-2xl border border-slate-200 bg-white p-8 shadow-sm dark:border-slate-800 dark:bg-slate-900">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h1 className="text-2xl font-bold text-slate-900 dark:text-white">
              Perfil da Imobiliária (Estrutura Preparada)
            </h1>
        ...
        <p className="mt-6 text-sm text-slate-600 dark:text-slate-400 leading-relaxed">
          Esta rota pública exibirá as informações institucionais, CRECI e o
          inventário completo de anúncios da imobiliária parceira (conforme Seção 17 do MASTER_PLAN).
        </p>
