                    ...
                    <td className="px-4 py-3 text-right">
                      {log.changes ? (
                        <button
                          ...
                          className="px-2.5 py-1 rounded-lg bg-slate-100 hover:bg-slate-700 text-slate-600 text-xs font-medium"
                        >
                          Payload
                        </button>
                      ) : (
      ...
      {selectedLog && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/75 backdrop-blur-sm">
          <div className="bg-white border border-slate-200 rounded-2xl max-w-lg w-full p-6 space-y-4 shadow-2xl">
            ...
            <div className="p-4 rounded-xl bg-slate-50 border border-slate-200 text-slate-700 text-xs font-mono overflow-x-auto max-h-80">
